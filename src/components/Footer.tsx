...
return (
    <li>
        <Link href={link} className="duration-200 hover:text-blue-600 ">
            {text}
        </Link>
    </li>
)
...
return (
    <footer className="bg-gray-100  text-gray-700 ">
        <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 grid grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-16 py-20">
          ...
          <div className="relative w-32 md:h-12 transition-all duration-300 hover:opacity-90">
            <Image 
              src="/lg.png" 
              alt="Company Logo" 
              fill
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5">
            <div className="w-full flex flex-col md:flex-row gap-4 items-center sm:justify-between py-3 border-t border-gray-200  text-gray-700 ">
                <div className="flex text-center sm:text-left sm:min-w-max">
                    <p> © 2025 Realm by Rook. All right reserved </p>
                </div>
                <div className="flex justify-center sm:justify-end w-full gap-3">
                    ...
                    <a href="https://www.linkedin.com/company/realmco/" aria-label="social link" rel="noreferer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5 h-5" viewBox="0 0 16 16">
