    ...
    <section className="pt-10 pb-50">
      ...
      <div className="flex flex-col md:flex-row gap-y-8 items-center text-center md:text-left md:items-start md:justify-between">
                <div className="text-center space-y-6 max-w-2xl mx-auto md:mx-0 md:text-left">
                    <h1 className="text-3xl font-bold text-gray-900  capitalize">Our most recent Insights</h1>
                    
                </div>
                <div>
                    <Link href="/Insights" className="px-5 py-2.5 border border-gray-100  text-blue-600  flex items-center gap-x-3">
                        See More
